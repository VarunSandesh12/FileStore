...
APP_ID = int(os.environ.get("APP_ID", "28408609")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "d6ddeafb0c189d91b8197ad49103e806") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002563651230")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Varun") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7386464112")) # Owner id
#--------------------------------------------
...
DB_NAME = os.environ.get("DATABASE_NAME", "Varun")
#--------------------------------------------
